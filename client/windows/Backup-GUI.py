...
def listcli():
	path = "E:\\Huyen Trang\\project\\djangows\\client\\windows\\listcli.py"

	if not restore_file.get() and not backup_id.get():
		command = "python \"" + path + "\""
...
#Apply to the list
list2.configure(yscrollcommand=sr1.set, xscrollcommand=sr2.set)
